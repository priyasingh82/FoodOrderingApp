...
class AllRestaurantAdapter(
    private var restaurants: ArrayList<Restaurant>, val context: Context) :
    RecyclerView.Adapter<AllRestaurantAdapter.AllRestaurantsViewHolder>() {
    ...
    override fun onBindViewHolder(p0: AllRestaurantsViewHolder, p1: Int) {
        ...
        if (listOfFavourites.isNotEmpty() && listOfFavourites.contains(resObject.id.toString())) {
            ...
            p0.favImage.setImageResource(R.drawable.ic_empty_heart)
        }
