...
import com.example.myfoodapp.adapter.RestaurantMenuAdapter
import com.example.myfoodapp.database.OrderEntity
import com.example.myfoodapp.database.RestaurantDatabase
import com.example.myfoodapp.fragment.RestaurantFragment
import com.example.myfoodapp.model.FoodItem
                    ...
                    * Once the DB is cleared, notify the user that the order has been placed*/
                    if (success) {
                        ...
                        * Guess, you learned something new here*/
                        ...
                        val btnOk = dialog.findViewById<Button>(R.id.btnOk1)
