...
import com.example.myfoodapp.adapter.OrderHistoryAdapter
...
class OrderHistoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        sharedPreferences = (activity as Context).getSharedPreferences("FoodApp", Context.MODE_PRIVATE)
        userId = sharedPreferences.getString("u_id", null) as String
