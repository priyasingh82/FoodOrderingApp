...
import com.example.myfoodapp.adapter.FavAdapter
...
import com.example.myfoodapp.util.DrawerLocker
...
class FavouritesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rlLoading = view.findViewById(R.id.rlLoading1)
